      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">
        {roles.map((role, idx) => (
          <div
            ...
            className="group cursor-pointer bg-white dark:bg-slate-900 rounded-[2.5rem] p-10 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:border-indigo-400 dark:hover:border-indigo-500 transition-all hover:-translate-y-2 animate-in fade-in zoom-in duration-500"
          ...
          >
            ...
            <p className="text-slate-500 font-medium dark:text-slate-400 leading-relaxed mb-8">
              {role.desc}
            </p>
